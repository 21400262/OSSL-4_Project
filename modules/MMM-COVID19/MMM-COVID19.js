...
Module.register("MMM-COVID19", {
  ...
  defaults: {
    header: 'COVID-19',
    countries: [ "S. Korea", "USA", "China", "Japan" ], // default list
    ...
    delta: false,
    showExtraInfo: false,
    highlightCountry: "S. Korea", // when containing a valid country ("countries:...") the row's background colour will be changed to enhance visibility 
    ...
    infoRowClass: "small", // small, medium or big
